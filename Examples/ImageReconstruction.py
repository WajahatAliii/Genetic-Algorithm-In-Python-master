...
sys.path.insert(0,'C:\\Users\\PMLS\\Downloads\\Genetic-Algorithm-In-Python-master')
...
# Read example image
image = cv2.imread('C:\\Users\\PMLS\\Downloads\\Genetic-Algorithm-In-Python-master/Examples/cross.jpg', 0)
